...
[![Azure build status](https://dev.azure.com/jedisct1/testing-azure-pipelines/_apis/build/status/jedisct1.libsodium?branchName=stable)](https://dev.azure.com/jedisct1/testing-azure-pipelines/_build/latest?definitionId=2&branchName=stable)
